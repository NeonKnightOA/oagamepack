...
python create_ent.py csv/entities.csv > ../install/OASVNPack/install/baseoa/entities.ent
python create_def.py csv/entities.csv > ../install/OASVNPack/install/baseoa/entities.def
python create_ent.py csv/entities.csv > ../oasvn.game/baseoa/entities.ent
python create_def.py csv/entities.csv > ../oasvn.game/baseoa/entities.def
echo Creating entity files for OAX (for OA SVN r951)...
python create_ent.py csv/entities_extra.csv > ../install/OASVNPack/install/baseoa/entities_oax.ent
python create_def.py csv/entities_extra.csv > ../install/OASVNPack/install/baseoa/entities_oax.def
python create_ent.py csv/entities_extra.csv > ../oasvn.game/baseoa/entities_oax.ent
python create_def.py csv/entities_extra.csv > ../oasvn.game/baseoa/entities_oax.def
pause
